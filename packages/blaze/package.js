...
Package.onUse(function (api) {
  ...
  api.use('check@2.0.0-alpha300.6');
  api.use('observe-sequence@2.0.0-alpha300.6');
  api.use('reactive-var@2.0.0-alpha300.6');
  api.use('ordered-dict@2.0.0-alpha300.6');
  ...
  api.imply('htmljs@2.0.0-alpha300.6');
...
Package.onTest(function (api) {
  ...
  api.use('blaze');
  api.use('blaze-tools@2.0.0-alpha300.6'); // for BlazeTools.toJS
