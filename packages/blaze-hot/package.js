...
Package.onUse(function (api) {
  api.use('modules@1.0.0-alpha300.6');
  api.use('ecmascript@1.0.0-alpha300.6');
  api.use('blaze@3.0.0-alpha300.6');
  api.use('templating-runtime@2.0.0-alpha300.6');
  api.use('hot-module-replacement@1.0.0-alpha300.6', { weak: true });
