...
const handleEndOfTag = (scanner, tag) => {
...
const getAttributeValue = (scanner, quote) => {
  if (quote) {
    if (scanner.peek() !== quote)
      return null;
    scanner.pos++;
